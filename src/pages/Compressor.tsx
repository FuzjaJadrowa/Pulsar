...
export const Compressor: React.FC = () => {
  ...
  useEffect(() => {
    ...
    body.classList.toggle("compressor-active", isDashboardVisible || filePath.trim().length > 0);
  ...
  return (
    <div className="page-root compressor-page">
        ...
        {isDashboardVisible && metadata && (
          <div id="compress-dashboard" className="compressor-dashboard">
            ...
            <div className="compressor-options-panel fade-in">
              ...
              <div id="compress-save-path-panel" className="compressor-path-selector fade-in">
                <input
                  type="text"
                ...
                />
                <button
                  id="compress-save-path-browse"
                  className="compressor-small-btn"
                  title={t("compressor.actions.browse", "Browse")}
      ...
      {/* Drag & drop overlay */}
      {showDropOverlay && (
        <div id="compress-drop-overlay" className="compress-drop-overlay visible" aria-hidden="false">
